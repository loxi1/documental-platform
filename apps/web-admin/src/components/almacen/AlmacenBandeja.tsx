...
export function AlmacenBandeja() {
  ...
  if (error) {
    return <div className="p-6 text-red-600">Error cargando bandeja de almacén.</div>;
  }
      ...
      <Card>
        <CardHeader className="gap-4">
          ...
          >
            ...
            <Input
              placeholder="Buscar OC, expediente, factura, guía, RUC o proveedor..."
              value={search}
                ...
                <table className="w-full min-w-[860px] text-sm">
                  ...
                  <tbody>
                    {paginatedRows.map((expediente) => {
                      ...
                      const tieneNotaIngreso = hasDocument(expediente, [
                        "NOTA_INGRESO",
                        "NOTA INGRESO",
                        "NOTA",
                        "NI",
                        ...
                        <tr key={expediente.id} className="border-b align-top hover:bg-muted/30">
                          ...
                          <td className="w-[22%] py-3 pr-4">
                            <div className="flex flex-wrap gap-1.5">
                              ...
                              <AdjuntosBadge label="NI" active={tieneNotaIngreso} />
                            </div>
