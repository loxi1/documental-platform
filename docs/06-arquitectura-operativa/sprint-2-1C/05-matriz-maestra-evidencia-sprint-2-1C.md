...
| EVID-2.1C-021 | Alcance del hash | No está confirmado si la búsqueda es global, por empresa, cliente o workspace | Código pendiente de revisión | Alcance no consolidado | DECISIÓN CONTRACTUAL PENDIENTE | Alto | Sí | Sí | Revisar repository/query exacta | Baseline funcional | Pendiente | Baseline 2.1C | N/A | N/A |
