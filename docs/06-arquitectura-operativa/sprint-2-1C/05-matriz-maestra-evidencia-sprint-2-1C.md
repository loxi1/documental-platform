...
| EVID-2.1C-018 | Duplicado secuencial | Debe repetirse la carga del mismo binario y hash | Plan autorizado | Pendiente de ejecución controlada | DECISIÓN CONTRACTUAL PENDIENTE | Alto | Sí | Sí | Ejecutar prueba secuencial autorizada | Producción controlada | Pendiente | Baseline 2.1C | Mismo usuario autorizado | Nuevo request ID |
